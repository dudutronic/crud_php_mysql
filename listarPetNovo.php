...
<br></br></br><h2>Listagem de Pets</h2></br>
</div>
    ...
    include "config.php";
						...
						$consulta = $pdo->prepare("SELECT * FROM cadastro_pet");
						$consulta->execute();
    ...
    ?>
            ...
            <tr>
                ...
                <td class="text-center"><a class='btn btn-info btn-xs' href="editar.php?ID_CADASTRO=<?=$listar->ID_CADASTRO;?>"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                 <a href="deletePet.php?ID_CADASTRO=<?=$listar->ID_CADASTRO;?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Del</a></td>
            </tr>
                        <?php
